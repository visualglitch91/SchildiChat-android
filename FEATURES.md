...
- Mark chats as unread ([MSC2867](https://github.com/matrix-org/matrix-spec-proposals/pull/2867), requires compatible clients to sync (SchildiChat, FluffyChat))
- Optionally count unread messages also for muted chats (display with a different color) ([MSC2654](https://github.com/matrix-org/matrix-spec-proposals/pull/2654), only works with synapse right now)
